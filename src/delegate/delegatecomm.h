...
#define CONSENSUS_ENROLL_INTERVAL_MAINNET 30
#define CONSENSUS_ENROLL_INTERVAL_TESTNET 6
#define CONSENSUS_ENROLL_INTERVAL SWITCH_PARAM(CONSENSUS_ENROLL_INTERVAL_MAINNET, CONSENSUS_ENROLL_INTERVAL_TESTNET)

#define CONSENSUS_DISTRIBUTE_INTERVAL_MAINNET 15
#define CONSENSUS_DISTRIBUTE_INTERVAL_TESTNET 3
#define CONSENSUS_DISTRIBUTE_INTERVAL SWITCH_PARAM(CONSENSUS_DISTRIBUTE_INTERVAL_MAINNET, CONSENSUS_DISTRIBUTE_INTERVAL_TESTNET)
