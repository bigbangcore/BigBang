...
protected:
    ...
    bool WaitLastBlock(const long nSeconds, const uint256& hashPrimary);
    bool WaitCurrentBlock(const long nSeconds, const uint256& hashPrimary);
