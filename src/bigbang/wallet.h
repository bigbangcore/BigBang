...
protected:
    ...
    bool SignDestination(const CDestination& destIn, const CTransaction& tx, const uint256& hash, std::vector<uint8>& vchSig, const int32 nForkHeight, bool& fCompleted, std::set<crypto::CPubKey>& setSignedKey);
