...
// rpc config
#define DEFAULT_RPCPORT 8802
#define DEFAULT_TESTNET_RPCPORT 8804
#define DEFAULT_RPC_MAX_CONNECTIONS 5
#define DEFAULT_RPC_CONNECT_TIMEOUT 600 //120

// network config
#define DEFAULT_P2PPORT 8801
#define DEFAULT_TESTNET_P2PPORT 8803
#define DEFAULT_DNSEED_PORT 8806
